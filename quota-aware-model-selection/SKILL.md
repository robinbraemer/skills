...
5. Use reported reset times, freshness, provider status, and per-window limits from quota tools such as [`quota-axi`](https://github.com/kunchenguid/quota-axi). Prefer live/fresh quota data; be conservative with stale or unknown data.
